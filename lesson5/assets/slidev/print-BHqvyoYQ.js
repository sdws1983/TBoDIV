import{d as _,aj as d,I as p,b as a,e as t,x as s,z as r,F as u,ai as h,o as l,S as f,l as g,g as v}from"../modules/vue-BpvmE1CY.js";import{A as x,c as m,y as b,B as y,_ as N}from"../index-uLtRjZ4N.js";import{N as k}from"./NoteDisplay-NSBdR5sr.js";import"../modules/unplugin-icons-DncwR1J3.js";import"../modules/shiki-BjWRagS5.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},S={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},V={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(C){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
