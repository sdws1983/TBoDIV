import{d as _,af as d,I as p,b as a,e as t,x as s,z as r,F as u,ae as h,o as l,V as f,l as g,g as v}from"../modules/vue-BoI2EFOv.js";import{A as x,c as m,y as b,B as y,_ as N}from"../index-BXwUvftx.js";import{N as k}from"./NoteDisplay-D2kMBMXW.js";import"../modules/unplugin-icons-CfAESjuq.js";import"../modules/shiki-DdzKTf6Q.js";const w={id:"page-root"},V={class:"m-4"},B={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},D={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z=t("div",{class:"flex-auto"},null,-1),A={key:0,class:"border-main mb-8"},C=_({__name:"print",setup(F){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
