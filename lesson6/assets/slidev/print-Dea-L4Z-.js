import{d as _,aj as d,I as p,b as a,e as t,x as s,z as r,F as u,ai as h,o as l,V as f,l as g,g as v}from"../modules/vue-5N1jcfw2.js";import{A as x,c as m,y as b,B as y,_ as N}from"../index-D8zXzsbI.js";import{N as k}from"./NoteDisplay-BZwQjbxb.js";import"../modules/unplugin-icons-DG8tEIxp.js";import"../modules/shiki-BcYRQcEZ.js";const w={id:"page-root"},V={class:"m-4"},B={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},D={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(C){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
